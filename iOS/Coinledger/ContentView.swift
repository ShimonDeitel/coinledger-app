...
struct ContentView: View {
    ...
    @State private var editingEntry: CoinEntry?
            ...
            ZStack {
                ...
                if store.entries.isEmpty {
                    VStack(spacing: 12) {
                        ...
                        Text("Tap + to log your first coin.")
                            .font(Theme.font(15))
...
struct EntryFormView: View {
    ...
    let existingID: UUID?
    let onSave: (CoinEntry) -> Void
    @FocusState private var focusedField: Field?

    enum Field { case title, detail1, detail2, note }

    init(entry: CoinEntry?, onSave: @escaping (CoinEntry) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existingID == nil ? "Add Coin" : "Edit Coin")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry = CoinEntry(title: title, detail1: detail1, detail2: detail2, note: note, date: date)
